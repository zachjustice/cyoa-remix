	...
	return (
		<div className={clsx(styles.field, className)}>
			<input
				...
				placeholder=" "
				{...inputProps}
				className="h-16 w-full rounded-lg border border-night-400 bg-night-700 px-4 pt-4 text-body-xs caret-white outline-none focus:border-accent-primary disabled:bg-night-400"
			/>
	...
	return (
		<div className={clsx(styles.textareaField, className)}>
			<textarea
				...
				placeholder=" "
				{...textareaProps}
				className="h-48 w-full rounded-lg border border-night-400 bg-night-700 px-4 pt-8 text-body-xs caret-white outline-none focus:border-accent-primary disabled:bg-night-400"
			/>
			{/* the label comes after the input so we can use the sibling selector in the CSS to give us animated label control in CSS only */}
			<label htmlFor={id} {...labelProps} />
