...
async function sendPasswordResetEmail({
	...
	await sendEmail({
		to: user.email,
		subject: `Choose Your Own Adventure! Password Reset`,
		...
		<html>
			...
			<body>
				<h1>Reset your Choose Your Own Adventure! password.</h1>
				<p>Click the link below to reset the Choose Your Own Adventure! password for ${user.username}.</p>
...
export const meta: MetaFunction = () => {
	return [{ title: 'Password Recovery for Choose Your Own Adventure!' }]
}
