...
export default function GetPageRoute() {
	...
	return (
		<div className="border-day-border h-fit w-full max-w-2xl rounded border-[1px] bg-day-primary-highlight p-8 dark:border-night-border dark:bg-night-primary-highlight">
